...
import FDProfitLossTable from "../../../components/Bets/FDProfitLoss/FDProfitLossTable";

const FDProfitLoss = ({ colors }: any) => {
  ...
  return (
    <div className="mt-[30px]">
      ...
      <div>
        <FDProfitLossTable colors={colors} />
      </div>
    </div>
  );
};

export default FDProfitLoss;
